...
export const CampaignVariateSettingsCombinationsItem: core.serialization.ObjectSchema<
    serializers.CampaignVariateSettingsCombinationsItem.Raw,
    Mailchimp.CampaignVariateSettingsCombinationsItem
...
export declare namespace CampaignVariateSettingsCombinationsItem {
