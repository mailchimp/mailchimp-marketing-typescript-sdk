...
export const ListsPostLocation: core.serialization.ObjectSchema<
    serializers.ListsPostLocation.Raw,
    Mailchimp.ListsPostLocation
...
export declare namespace ListsPostLocation {
