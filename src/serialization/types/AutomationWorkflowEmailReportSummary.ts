...
export const AutomationWorkflowEmailReportSummary: core.serialization.ObjectSchema<
    serializers.AutomationWorkflowEmailReportSummary.Raw,
    Mailchimp.AutomationWorkflowEmailReportSummary
...
export declare namespace AutomationWorkflowEmailReportSummary {
