...
export const CampaignReportAbSplitA: core.serialization.ObjectSchema<
    serializers.CampaignReportAbSplitA.Raw,
    Mailchimp.CampaignReportAbSplitA
...
export declare namespace CampaignReportAbSplitA {
