...
export const EcommerceStoresCartsPatchAddress: core.serialization.ObjectSchema<
    serializers.EcommerceStoresCartsPatchAddress.Raw,
    Mailchimp.EcommerceStoresCartsPatchAddress
...
export declare namespace EcommerceStoresCartsPatchAddress {
