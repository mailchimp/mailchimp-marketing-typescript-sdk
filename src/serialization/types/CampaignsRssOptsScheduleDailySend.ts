...
export const CampaignsRssOptsScheduleDailySend: core.serialization.ObjectSchema<
    serializers.CampaignsRssOptsScheduleDailySend.Raw,
    Mailchimp.CampaignsRssOptsScheduleDailySend
...
export declare namespace CampaignsRssOptsScheduleDailySend {
