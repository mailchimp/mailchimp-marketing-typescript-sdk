...
export const ListWebhooksEvents: core.serialization.ObjectSchema<
    serializers.ListWebhooksEvents.Raw,
    Mailchimp.ListWebhooksEvents
...
export declare namespace ListWebhooksEvents {
