...
export const EcommerceStoresCartsPostAddress: core.serialization.ObjectSchema<
    serializers.EcommerceStoresCartsPostAddress.Raw,
    Mailchimp.EcommerceStoresCartsPostAddress
...
export declare namespace EcommerceStoresCartsPostAddress {
