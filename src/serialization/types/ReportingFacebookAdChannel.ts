...
export const ReportingFacebookAdChannel: core.serialization.ObjectSchema<
    serializers.ReportingFacebookAdChannel.Raw,
    Mailchimp.ReportingFacebookAdChannel
...
export declare namespace ReportingFacebookAdChannel {
