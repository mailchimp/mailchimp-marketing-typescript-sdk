...
export const ECommerceOrderBillingAddress: core.serialization.ObjectSchema<
    serializers.ECommerceOrderBillingAddress.Raw,
    Mailchimp.ECommerceOrderBillingAddress
...
export declare namespace ECommerceOrderBillingAddress {
