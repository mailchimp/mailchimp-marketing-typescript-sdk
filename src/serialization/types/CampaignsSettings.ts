...
export const CampaignsSettings: core.serialization.ObjectSchema<
    serializers.CampaignsSettings.Raw,
    Mailchimp.CampaignsSettings
...
export declare namespace CampaignsSettings {
