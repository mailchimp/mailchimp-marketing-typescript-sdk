...
import { GetSurveyReportingResponseStatus } from "./GetSurveyReportingResponseStatus.js";

export const GetSurveyReportingResponse: core.serialization.ObjectSchema<
    serializers.GetSurveyReportingResponse.Raw,
    Mailchimp.GetSurveyReportingResponse
> = core.serialization.object({
    ...
    status: GetSurveyReportingResponseStatus.optional(),
...
export declare namespace GetSurveyReportingResponse {
    export interface Raw {
        ...
        status?: GetSurveyReportingResponseStatus.Raw | null;
        title?: string | null;
