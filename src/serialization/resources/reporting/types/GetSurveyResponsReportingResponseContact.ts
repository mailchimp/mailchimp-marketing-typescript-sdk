...
import { GetSurveyResponsReportingResponseContactStatus } from "./GetSurveyResponsReportingResponseContactStatus.js";

export const GetSurveyResponsReportingResponseContact: core.serialization.ObjectSchema<
    serializers.GetSurveyResponsReportingResponseContact.Raw,
    Mailchimp.GetSurveyResponsReportingResponseContact
> = core.serialization.object({
    ...
    status: GetSurveyResponsReportingResponseContactStatus.optional(),
});

export declare namespace GetSurveyResponsReportingResponseContact {
    export interface Raw {
        ...
        phone?: string | null;
        status?: GetSurveyResponsReportingResponseContactStatus.Raw | null;
    }
}
