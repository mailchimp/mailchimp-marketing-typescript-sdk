...
export const CreateLandingPagesRequestTracking: core.serialization.ObjectSchema<
    serializers.CreateLandingPagesRequestTracking.Raw,
    Mailchimp.CreateLandingPagesRequestTracking
...
export declare namespace CreateLandingPagesRequestTracking {
