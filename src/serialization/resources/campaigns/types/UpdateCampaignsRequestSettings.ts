...
export const UpdateCampaignsRequestSettings: core.serialization.ObjectSchema<
    serializers.UpdateCampaignsRequestSettings.Raw,
    Mailchimp.UpdateCampaignsRequestSettings
...
export declare namespace UpdateCampaignsRequestSettings {
