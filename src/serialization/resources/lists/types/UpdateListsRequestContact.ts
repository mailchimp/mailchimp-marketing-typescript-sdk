...
export const UpdateListsRequestContact: core.serialization.ObjectSchema<
    serializers.UpdateListsRequestContact.Raw,
    Mailchimp.UpdateListsRequestContact
...
export declare namespace UpdateListsRequestContact {
