...
export const ListEcommerceProductActivityReportsResponseProductsItem: core.serialization.ObjectSchema<
    serializers.ListEcommerceProductActivityReportsResponseProductsItem.Raw,
...
export declare namespace ListEcommerceProductActivityReportsResponseProductsItem {
