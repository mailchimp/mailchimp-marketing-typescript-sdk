...
import { GetVerifiedDomainsResponseStatus } from "./GetVerifiedDomainsResponseStatus.js";

export const GetVerifiedDomainsResponse: core.serialization.ObjectSchema<
    serializers.GetVerifiedDomainsResponse.Raw,
    Mailchimp.GetVerifiedDomainsResponse
> = core.serialization.object({
    ...
    status: GetVerifiedDomainsResponseStatus.optional(),
...
export declare namespace GetVerifiedDomainsResponse {
    export interface Raw {
        authenticated?: boolean | null;
        domain?: string | null;
        is_free_email_provider?: boolean | null;
        status?: GetVerifiedDomainsResponseStatus.Raw | null;
