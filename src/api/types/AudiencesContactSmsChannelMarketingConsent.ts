 ...
 */
export interface AudiencesContactSmsChannelMarketingConsent {
    /** The source from which the parent's entity was created. */
    source?: Mailchimp.AudiencesContactSmsChannelMarketingConsentSource;
    ...
    status?: Mailchimp.AudiencesContactSmsChannelMarketingConsentStatus;
