...
export interface Campaigns {
    ...
    _links?: Campaigns.Links.Item[] | undefined;
    ab_split_opts?: Mailchimp.AbTestingOptions | undefined;
    /** The link to the campaign's archive version in ISO 8601 format. */
    archive_url?: string | undefined;
    /** How the campaign's content is put together. */
    content_type?: Campaigns.ContentType | undefined;
    /** The date and time the campaign was created in ISO 8601 format. */
    create_time?: string | undefined;
    /** Updates on campaigns in the process of sending. */
    delivery_status?: Campaigns.DeliveryStatus | undefined;
    ...
    recipients?: Campaigns.Recipients | undefined;
    /** For sent campaigns, a summary of opens, clicks, and e-commerce data. */
    report_summary?: Campaigns.ReportSummary | undefined;
    ...
    resend_shortcut_eligibility?: Campaigns.ResendShortcutEligibility | undefined;
    /** Information about campaigns related through shortcuts. */
    resend_shortcut_usage?: Campaigns.ResendShortcutUsage | undefined;
    /** Determines if the campaign qualifies to be resent to non-openers. */
    resendable?: boolean | undefined;
    /** [RSS](https://mailchimp.com/help/share-your-blog-posts-with-mailchimp/) options for a campaign. */
    rss_opts?: Campaigns.RssOpts | undefined;
    /** The date and time a campaign was sent. */
    send_time?: string | undefined;
    /** The settings for your campaign, including subject, from name, reply-to address, and more. */
    settings?: Campaigns.Settings | undefined;
    /** The preview for the campaign, rendered by social networks like Facebook and Twitter. [Learn more](https://mailchimp.com/help/enable-and-customize-social-cards/). */
    social_card?: Campaigns.SocialCard | undefined;
    /** The current status of the campaign. */
    status?: Campaigns.Status | undefined;
    tracking?: Mailchimp.CampaignTrackingOptions | undefined;
    /** There are four types of [campaigns](https://mailchimp.com/help/getting-started-with-campaigns/) you can create in Mailchimp. A/B Split campaigns have been deprecated and variate campaigns should be used instead. */
    type?: Campaigns.Type | undefined;
    /** The settings specific to A/B test campaigns. */
    variate_settings?: Campaigns.VariateSettings | undefined;
...
export namespace Campaigns {
     ...
     * Determines if the campaign qualifies for the Campaign Resend Shortcuts. Only included when query parameter `include_resend_shortcuts` is `true`.
     */
    export interface ResendShortcutEligibility {
        /** Determines if the campaign qualifies to be resent to new subscribers. */
        to_new_subscribers?: ResendShortcutEligibility.ToNewSubscribers | undefined;
        /** Determines if the campaign qualifies to be resent to non-clickers. */
        to_non_clickers?: ResendShortcutEligibility.ToNonClickers | undefined;
        /** Determines if the campaign qualifies to be resent to non-openers. */
        to_non_openers?: ResendShortcutEligibility.ToNonOpeners | undefined;
        /** Determines if the campaign qualifies to be resent to non-purchasers. */
        to_non_purchasers?: ResendShortcutEligibility.ToNonPurchasers | undefined;
    }

    export namespace ResendShortcutEligibility {
        /**
         * Determines if the campaign qualifies to be resent to new subscribers.
         */
        export interface ToNewSubscribers {
            /** Determines if the campaign qualifies to be resent to this segment. */
            is_eligible?: boolean | undefined;
         ...
         * Determines if the campaign qualifies to be resent to non-clickers.
         */
        export interface ToNonClickers {
            /** Determines if the campaign qualifies to be resent to this segment. */
            is_eligible?: boolean | undefined;
            /** The reason the campaign is not eligible to be resent to this segment. */
            reason?: string | undefined;
         ...
         * Determines if the campaign qualifies to be resent to non-purchasers.
         */
        export interface ToNonPurchasers {
            /** Determines if the campaign qualifies to be resent to this segment. */
            is_eligible?: boolean | undefined;
            /** The reason the campaign is not eligible to be resent to this segment. */
            reason?: string | undefined;
     ...
     * Information about campaigns related through shortcuts.
     */
    export interface ResendShortcutUsage {
        /** The original campaign that was resent. */
        original_campaign?: ResendShortcutUsage.OriginalCampaign | undefined;
        /** Campaigns that were created from Campaign Resend Shortcuts for this campaign */
        shortcut_campaigns?: ResendShortcutUsage.ShortcutCampaigns.Item[] | undefined;
    }

    export namespace ResendShortcutUsage {
        /**
         * The original campaign that was resent.
         */
        export interface OriginalCampaign {
            /** ID for the resent campaign. */
            id?: string | undefined;
            /** Which campaign resend shortcut was used. */
            shortcut_type?: OriginalCampaign.ShortcutType | undefined;
        ...
        export namespace OriginalCampaign {
            /** Which campaign resend shortcut was used. */
            export const ShortcutType = {
                NonOpeners: "non_openers",
                NewSubscribers: "new_subscribers",
                NonClickers: "non_clickers",
                NonPurchasers: "non_purchasers",
            } as const;
            export type ShortcutType = (typeof ShortcutType)[keyof typeof ShortcutType];
        }

        export type ShortcutCampaigns = ShortcutCampaigns.Item[];

        export namespace ShortcutCampaigns {
            export interface Item {
                ...
                send_time?: string | undefined;
                /** Which campaign resend shortcut was used. */
                shortcut_type?: Item.ShortcutType | undefined;
                /** The current status of the campaign. */
