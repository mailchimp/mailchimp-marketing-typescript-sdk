...
export const SignupFormStylesItemSelector = {
...
export type SignupFormStylesItemSelector =
    (typeof SignupFormStylesItemSelector)[keyof typeof SignupFormStylesItemSelector];
