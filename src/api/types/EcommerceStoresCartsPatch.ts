...
export interface EcommerceStoresCartsPatch {
    ...
    address?: EcommerceStoresCartsPatch.Address | undefined;
    ...
    total_spent?: EcommerceStoresCartsPatch.TotalSpent | undefined;
}

export namespace EcommerceStoresCartsPatch {
    /**
     * The customer's address.
     */
