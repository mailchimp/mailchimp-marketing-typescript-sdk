 ...
 */
export interface AudiencesContactEmailChannelMarketingConsent {
    /** The source from which the parent's entity was created. */
    source?: Mailchimp.AudiencesContactEmailChannelMarketingConsentSource;
    status?: Mailchimp.AudiencesContactEmailChannelMarketingConsentStatus;
