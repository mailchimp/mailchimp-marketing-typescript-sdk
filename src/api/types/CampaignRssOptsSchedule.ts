 ...
 */
export interface CampaignRssOptsSchedule {
    /** The days of the week to send a daily RSS Campaign. */
    dailySend?: Mailchimp.CampaignRssOptsScheduleDailySend;
    ...
    weeklySendDay?: Mailchimp.CampaignRssOptsScheduleWeeklySendDay;
}
