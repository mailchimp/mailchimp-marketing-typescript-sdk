 ...
 */
export interface CampaignVariateSettings {
    /** Combinations of possible variables used to build emails. */
    combinations?: Mailchimp.CampaignVariateSettingsCombinationsItem[];
    ...
    winnerCriteria: Mailchimp.CampaignVariateSettingsWinnerCriteria;
