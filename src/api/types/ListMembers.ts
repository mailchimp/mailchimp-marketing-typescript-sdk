...
export interface ListMembers {
    ...
    _links?: ListMembers.Links.Item[] | undefined;
    ...
    last_note?: ListMembers.LastNote | undefined;
    /** The list id. */
    list_id?: string | undefined;
    /** Subscriber location information. */
    location?: ListMembers.Location | undefined;
    /** The marketing permissions for the subscriber. */
    marketing_permissions?: ListMembers.MarketingPermissions.Item[] | undefined;
    /** Star rating for this member, between 1 and 5. */
    member_rating?: number | undefined;
    /** A dictionary of merge fields where the keys are the merge tags. See the [Merge Fields documentation](https://mailchimp.com/developer/marketing/docs/merge-fields/#structure) for more about the structure. */
    merge_fields?: Record<string, ListMembers.MergeFields.Value> | undefined;
    ...
    sms_subscription_status?: ListMembers.SmsSubscriptionStatus | undefined;
    /** The source from which the subscriber was added to this list. */
    source?: string | undefined;
    /** Open and click rates for this subscriber. */
    stats?: ListMembers.Stats | undefined;
    /** Subscriber's current status. */
    status?: ListMembers.Status | undefined;
    ...
    tags?: ListMembers.Tags.Item[] | undefined;
...
export namespace ListMembers {
    ...
    /** The status of an SMS subscription. */
    export const SmsSubscriptionStatus = {
        Subscribed: "subscribed",
        Unsubscribed: "unsubscribed",
        Nonsubscribed: "nonsubscribed",
        Pending: "pending",
    } as const;
    export type SmsSubscriptionStatus = (typeof SmsSubscriptionStatus)[keyof typeof SmsSubscriptionStatus];
    ...
    export interface Stats {
        ...
        ecommerce_data?: Stats.EcommerceData | undefined;
    }
