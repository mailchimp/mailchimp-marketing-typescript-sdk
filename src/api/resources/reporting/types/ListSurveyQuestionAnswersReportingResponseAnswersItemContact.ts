 ...
 */
export interface ListSurveyQuestionAnswersReportingResponseAnswersItemContact {
    ...
    status?: Mailchimp.ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus;
}
