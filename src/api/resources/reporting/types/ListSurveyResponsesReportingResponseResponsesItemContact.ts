 ...
 */
export interface ListSurveyResponsesReportingResponseResponsesItemContact {
    ...
    status?: Mailchimp.ListSurveyResponsesReportingResponseResponsesItemContactStatus;
}
