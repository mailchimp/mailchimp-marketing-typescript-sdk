...
export interface ListAbuseReportsListsResponse {
    ...
    _links?: ListAbuseReportsListsResponse.Links.Item[] | undefined;
    /** An array of objects, each representing an abuse report resource. */
    abuse_reports?: Mailchimp.ListsAbuseReports[] | undefined;
...
export namespace ListAbuseReportsListsResponse {
