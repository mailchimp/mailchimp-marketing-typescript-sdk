...
export interface ListMemberEventsListsResponse {
    ...
    _links?: ListMemberEventsListsResponse.Links.Item[] | undefined;
    /** An array of objects, each representing an event. */
    events?: ListMemberEventsListsResponse.Events.Item[] | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
}

export namespace ListMemberEventsListsResponse {
