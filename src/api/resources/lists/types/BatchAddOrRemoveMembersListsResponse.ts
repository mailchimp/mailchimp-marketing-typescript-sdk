...
export interface BatchAddOrRemoveMembersListsResponse {
    ...
    _links?: BatchAddOrRemoveMembersListsResponse.Links.Item[] | undefined;
    ...
    errors?: BatchAddOrRemoveMembersListsResponse.Errors.Item[] | undefined;
    /** An array of objects, each representing a new member that was added to the static segment. */
    members_added?: Mailchimp.ListsPost[] | undefined;
    /** An array of objects, each representing an existing list member that got deleted from the static segment. */
    members_removed?: Mailchimp.ListsPost[] | undefined;
    /** The total number of items matching the query, irrespective of pagination. */
    total_added?: number | undefined;
    /** The total number of items matching the query, irrespective of pagination. */
    total_removed?: number | undefined;
}

export namespace BatchAddOrRemoveMembersListsResponse {
