...
export class RootClient {
    ...
    constructor(options: RootClient.Options) {
     ...
     *
     * @param {Mailchimp.ListRootRequest} request
     * @param {RootClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<Mailchimp.ListRootResponse> {
    ...
    private async __list(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/3.0/");
    }
}
