...
export interface ListMessagesConversationsResponse {
    ...
    _links?: ListMessagesConversationsResponse.Links.Item[] | undefined;
    /** A string that identifies this conversation. */
    conversation_id?: string | undefined;
    /** An array of objects, each representing a conversation messages resources. */
    conversation_messages?: Mailchimp.ConversationMessage[] | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
}

export namespace ListMessagesConversationsResponse {
