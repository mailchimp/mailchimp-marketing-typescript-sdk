...
export interface ListEmailsAutomationsResponse {
    ...
    _links?: ListEmailsAutomationsResponse.Links.Item[][] | undefined;
    /** An array of objects, each representing an email in an Automation workflow. */
    emails?: Mailchimp.AutomationWorkflowEmail[] | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
}

export namespace ListEmailsAutomationsResponse {
