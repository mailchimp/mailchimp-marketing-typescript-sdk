...
export interface ListSearchCampaignsResponse {
    ...
    _links?: ListSearchCampaignsResponse.Links.Item[] | undefined;
    /** An array of matching campaigns and snippets. */
    results?: ListSearchCampaignsResponse.Results.Item[] | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
}

export namespace ListSearchCampaignsResponse {
    ...
    export namespace Results {
        export interface Item {
            campaign?: Mailchimp.Campaigns | undefined;
