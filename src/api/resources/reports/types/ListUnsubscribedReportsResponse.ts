...
export interface ListUnsubscribedReportsResponse {
    ...
    _links?: ListUnsubscribedReportsResponse.Links.Item[] | undefined;
    /** The campaign id. */
    campaign_id?: string | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
    /** An array of objects, each representing a member who unsubscribed from a campaign. */
    unsubscribes?: Mailchimp.Unsubscribes[] | undefined;
}

export namespace ListUnsubscribedReportsResponse {
