...
export interface ListClickDetailsReportsResponse {
    ...
    _links?: ListClickDetailsReportsResponse.Links.Item[] | undefined;
    /** The campaign id. */
    campaign_id?: string | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
    /** An array of objects, each representing a specific URL contained in the campaign. */
    urls_clicked?: Mailchimp.ClickDetailReport[] | undefined;
}

export namespace ListClickDetailsReportsResponse {
