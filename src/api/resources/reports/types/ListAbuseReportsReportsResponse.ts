...
export interface ListAbuseReportsReportsResponse {
    ...
    _links?: ListAbuseReportsReportsResponse.Links.Item[] | undefined;
    /** An array of objects, each representing an abuse report resource. */
    abuse_reports?: Mailchimp.AbuseComplaint[] | undefined;
    /** The campaign id. */
...
export namespace ListAbuseReportsReportsResponse {
