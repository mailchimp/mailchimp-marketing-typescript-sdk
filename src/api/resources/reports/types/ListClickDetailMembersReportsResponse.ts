...
export interface ListClickDetailMembersReportsResponse {
    ...
    _links?: ListClickDetailMembersReportsResponse.Links.Item[] | undefined;
    /** The campaign id. */
    campaign_id?: string | undefined;
    /** An array of objects, each representing a member who clicked a specific link within a campaign. */
    members?: Mailchimp.ClickDetailMember[] | undefined;
    /** The total number of items matching the query regardless of pagination. */
    total_items?: number | undefined;
}

export namespace ListClickDetailMembersReportsResponse {
