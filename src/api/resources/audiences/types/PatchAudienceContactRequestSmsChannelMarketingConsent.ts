 ...
 */
export interface PatchAudienceContactRequestSmsChannelMarketingConsent {
    /** The source from which the parent's entity was created. */
    source?: Mailchimp.PatchAudienceContactRequestSmsChannelMarketingConsentSource;
    ...
    status?: Mailchimp.PatchAudienceContactRequestSmsChannelMarketingConsentStatus;
