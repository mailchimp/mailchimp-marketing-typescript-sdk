 ...
 */
export interface UpdateCampaignsRequestVariateSettings {
    ...
    sendTimes?: Mailchimp.UpdateCampaignsRequestVariateSettingsSendTimesItem[];
    ...
    winnerCriteria?: Mailchimp.UpdateCampaignsRequestVariateSettingsWinnerCriteria;
}
