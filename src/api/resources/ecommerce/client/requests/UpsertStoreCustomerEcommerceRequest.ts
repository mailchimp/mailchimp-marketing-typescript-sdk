...
export interface UpsertStoreCustomerEcommerceRequest {
    ...
    address?: UpsertStoreCustomerEcommerceRequest.Address;
    ...
    total_spent?: UpsertStoreCustomerEcommerceRequest.TotalSpent;
}

export namespace UpsertStoreCustomerEcommerceRequest {
    /**
     * The customer's address.
     */
