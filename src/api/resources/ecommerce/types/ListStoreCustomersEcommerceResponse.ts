...
export interface ListStoreCustomersEcommerceResponse {
    ...
    _links?: ListStoreCustomersEcommerceResponse.Links.Item[] | undefined;
    /** An array of objects, each representing a customer of a store. */
    customers?: Mailchimp.ECommerceCustomer[] | undefined;
    /** The store id. */
...
export namespace ListStoreCustomersEcommerceResponse {
