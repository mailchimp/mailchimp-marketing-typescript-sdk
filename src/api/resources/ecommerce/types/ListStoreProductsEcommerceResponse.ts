...
export interface ListStoreProductsEcommerceResponse {
    ...
    _links?: ListStoreProductsEcommerceResponse.Links.Item[] | undefined;
    /** An array of objects, each representing a store product. */
    products?: Mailchimp.ECommerceProduct[] | undefined;
    /** The store id. */
...
export namespace ListStoreProductsEcommerceResponse {
