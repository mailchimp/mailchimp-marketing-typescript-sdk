 ...
 */
export interface UpdateStoreOrderEcommerceRequestBillingAddress {
    /** The billing address for the order. */
    address1?: string;
    ...
    latitude?: Mailchimp.UpdateStoreOrderEcommerceRequestBillingAddressLatitude;
    /** The longitude for the billing address location. */
    longitude?: Mailchimp.UpdateStoreOrderEcommerceRequestBillingAddressLongitude;
