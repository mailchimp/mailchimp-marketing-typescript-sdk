 ...
 * The store address.
 */
export interface CreateStoreEcommerceRequestAddress {
    ...
    latitude?: Mailchimp.CreateStoreEcommerceRequestAddressLatitude;
    /** The longitude of the store location. */
    longitude?: Mailchimp.CreateStoreEcommerceRequestAddressLongitude;
