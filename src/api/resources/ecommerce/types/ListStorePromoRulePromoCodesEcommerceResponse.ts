...
export interface ListStorePromoRulePromoCodesEcommerceResponse {
    ...
    _links?: ListStorePromoRulePromoCodesEcommerceResponse.Links.Item[] | undefined;
    /** An array of objects, each representing promo codes defined for a store. */
    promo_codes?: Mailchimp.ECommercePromoCode[] | undefined;
    /** The store id. */
...
export namespace ListStorePromoRulePromoCodesEcommerceResponse {
